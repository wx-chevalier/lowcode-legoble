import { LegoJsonSchema, LegoUiSchema } from './schema';

/** 设置 UiSchema 中所有元素的某个属性 */
export function setUiSchemaFieldsProperty(
  { jsonSchema, uiSchema }: { jsonSchema: LegoJsonSchema; uiSchema: LegoUiSchema },
  ...
  propertyNames.forEach(propertyName => {
    ...
    let propertyUiSchema: LegoUiSchema | LegoUiSchema[];
